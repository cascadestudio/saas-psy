...
**Source** : Kroenke, Spitzer & Williams, 2001 • traduction française Arthurs et al., 2012
...
- Consigne : *« Au cours des 2 dernières semaines, selon quelle fréquence avez-vous été gêné(e) par les problèmes suivants ? »*
...
2. **Libellés de sévérité** — *Minimale / Légère / Modérée / Modérément sévère / Sévère* : ce sont les termes français standards, à confirmer.
