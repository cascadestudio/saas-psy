...
export default function EchelleDanxieteDeLiebovitch(props: QuestionnaireProps) {
  ...
  // Create the questionnaire content
  ...
  // Pass the rendered questions as children to the base component
  return <BaseQuestionnaire {...props}>{questionsContent}</BaseQuestionnaire>;
}
