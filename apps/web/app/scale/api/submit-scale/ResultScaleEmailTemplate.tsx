...
interface ResultScaleEmailTemplateProps {
...
export const ResultScaleEmailTemplate = ({
  patientFirstname,
  patientLastname,
  scaleTitle,
  scoreResult,
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Résultats du questionnaire {scaleTitle} pour {patientFirstname}{" "}
        {patientLastname}
      </Preview>
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={sectionStyle}>
            ...
            <Text style={textStyle}>
              <strong>Questionnaire:</strong> {scaleTitle}
            </Text>
          </Section>
