        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {plans.map((plan) => (
              ...
              >
                {plan.highlighted && (
                  <Badge className="absolute -top-3 left-6 bg-brand-orange text-brand-white border-transparent">
                    Recommandé
                  </Badge>
                )}
                ...
                <div className="mt-8">
                  <WaitlistButton
                    ...
                    className={
                      plan.highlighted
                        ? "w-full bg-brand-orange text-brand-white hover:bg-brand-orange/90"
                        : "w-full border-brand-orange text-brand-orange hover:bg-brand-orange hover:text-brand-white"
                    }
                    size="lg"
                  >
                    {plan.cta}
