...
exports.buildPractitionerCompletionEmailHtml = buildPractitionerCompletionEmailHtml;
exports.buildSessionEmailHtml = buildSessionEmailHtml;
function buildBatchEmailHtml(params) {
...
function buildPractitionerCompletionEmailHtml(params) {
    const { practitionerFirstName, patientFirstName, patientLastName, scaleName, sessionUrl, logoUrl, } = params;
    const greeting = practitionerFirstName
        ? `Bonjour ${practitionerFirstName},`
        : 'Bonjour,';
    return `<!DOCTYPE html>
<html>
<head>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="padding: 36px 40px;">
                    ...
                    <p style="margin: 0 0 20px 0; color: #374151; font-size: 16px; line-height: 26px;">
                      <strong>${patientFirstName} ${patientLastName}</strong> vient de compl&eacute;ter le questionnaire <strong>${scaleName}</strong>.
                    </p>
                    <p style="margin: 0 0 32px 0; color: #374151; font-size: 16px; line-height: 26px;">
                      Les r&eacute;sultats et leur interpr&eacute;tation sont disponibles dans votre tableau de bord.
                    </p>
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center">
                          <a href="${sessionUrl}" style="display: inline-block; padding: 14px 36px; background-color: #D6591F; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; border-radius: 100px;">
                    ...
                    <p style="margin: 28px 0 0 0; color: #6b7280; font-size: 13px; line-height: 20px;">
                      Ou copiez ce lien dans votre navigateur :<br>
                      <a href="${sessionUrl}" style="color: #D6591F; word-break: break-all;">${sessionUrl}</a>
                    </p>
                  </td>
                </tr>
                <tr>
...
function buildSessionEmailHtml(params) {
