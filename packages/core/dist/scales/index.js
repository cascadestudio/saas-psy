...
exports.scales = [
    ...
    },
    {
        ...
        description: "Un questionnaire de 10 items évaluant les expériences de dissociation vécues pendant un événement traumatogène et immédiatement après",
        category: "Traumatismes",
        ...
        instructions: "Veuillez répondre aux énoncés suivants en choisissant la réponse qui décrit le mieux vos expériences et réactions durant l'événement et immédiatement après.\n\nSi une question ne s'applique pas à votre expérience, répondez « pas du tout vrai ».",
        persistentInstructions: "Durant l'événement et immédiatement après :",
        copyrightAttribution: "PDEQ — Marmar, Weiss & Metzler (1997) ©1997. Traduction française et validation : Birmes et al. (2005), European Psychiatry. Mise en page : Centre national de ressources et de résilience (Cn2r).",
        higherIsBetter: false,
        questions: [
        ...
        scoring: {
            ...
            maxScore: 50,
            method: "Additionnez les scores de chaque item (1-5). Le score total varie de 10 à 50. Un score ≥ 15 permet le dépistage d'une dissociation péritraumatique significative.",
        },
    },
    {
        id: "eii",
        ...
        description: "Une échelle de 27 items mesurant les réactions émotionnelles, cognitives et comportementales face à l'incertitude de la vie",
        category: "Anxiété généralisée",
        estimatedTime: "5-10 minutes",
        ...
        instructions: "Voici une série d'énoncés qui représentent comment les gens peuvent réagir à l'incertitude dans la vie.\n\nVeuillez indiquer jusqu'à quel point chacun des énoncés suivants correspond à vous.",
        persistentInstructions: "Jusqu'à quel point cet énoncé correspond-il à vous ?",
        copyrightAttribution: "Échelle d'intolérance à l'incertitude (ÉII / IUS) — Freeston, Rhéaume, Letarte, Dugas & Ladouceur (1994), Personality and Individual Differences, 17, 791-802. Instrument original francophone.",
        higherIsBetter: false,
        questions: [
            ...
            ranges: [
                {
                    min: 27,
                    max: 135,
                    interpretation: "Plus le score est élevé, plus l'intolérance à l'incertitude est marquée.",
                },
            ],
            maxScore: 135,
            method: "Additionnez les scores des 27 items (1-5). Le score total varie de 27 à 135. Pas de seuil clinique établi ; la cotation bifactorielle (facteurs 1 et 2) est fournie en sous-scores.",
        },
    },
    {
        id: "cudit-r",
        ...
        description: "Un questionnaire de 8 items repérant une consommation de cannabis problématique ou un trouble de l'usage au cours des 6 derniers mois",
        category: "Addictions",
        estimatedTime: "2-3 minutes",
        ...
        instructions: "Ce questionnaire s'adresse aux personnes ayant consommé du cannabis au cours des 6 derniers mois.\n\nRépondez aux questions suivantes en choisissant la réponse qui correspond le plus à votre consommation de cannabis au cours des 6 derniers mois. Veuillez répondre à toutes les questions.",
        persistentInstructions: "Votre consommation au cours des 6 derniers mois :",
        copyrightAttribution: "CUDIT-R — Adamson, Kay-Lambkin, Baker, Lewin, Thornton, Kelly & Sellman (2010). Version française (CUDIT-R-Fr) : Luquiens et al. (2021), Drug and Alcohol Review. Diffusion : RESPADD.",
        higherIsBetter: false,
        questions: [
            {
                title: "Fréquence de consommation",
            ...
            },
            {
                ...
                prompt: "Combien d'heures êtes-vous « défoncé(e) » un jour typique où vous consommez du cannabis ?",
                options: [
            ...
            {
                title: "Perte de contrôle",
                prompt: "Au cours des 6 derniers mois, à quelle fréquence avez-vous constaté que vous n'étiez plus capable de vous arrêter de fumer du cannabis une fois que vous aviez commencé ?",
                options: [
                    { value: 0, text: "Jamais" },
                    { value: 1, text: "Moins d'une fois par mois" },
            ...
            {
                title: "Obligations non remplies",
                prompt: "Au cours des 6 derniers mois, combien de fois votre consommation de cannabis vous a-t-elle empêché de faire ce qui était normalement attendu de vous ?",
                options: [
                    { value: 0, text: "Jamais" },
                    { value: 1, text: "Moins d'une fois par mois" },
                    { value: 2, text: "Environ une fois par mois" },
            ...
            },
            {
                ...
                prompt: "Au cours des 6 derniers mois, combien de fois avez-vous passé une grande partie de votre temps à chercher à vous procurer ou à consommer du cannabis, ou à vous remettre des effets du cannabis ?",
                options: [
                    { value: 0, text: "Jamais" },
                    { value: 1, text: "Moins d'une fois par mois" },
                    { value: 2, text: "Environ une fois par mois" },
            ...
            },
            {
                ...
                prompt: "Au cours des 6 derniers mois, combien de fois avez-vous éprouvé des problèmes de mémoire ou de concentration après avoir fumé du cannabis ?",
                options: [
                    { value: 0, text: "Jamais" },
                    { value: 1, text: "Moins d'une fois par mois" },
                    { value: 2, text: "Environ une fois par mois" },
            ...
            },
            {
                ...
                prompt: "À quelle fréquence consommez-vous du cannabis dans des situations qui pourraient entraîner un danger, par exemple conduire un véhicule, utiliser une machine, ou s'occuper d'enfants ?",
                options: [
                    { value: 0, text: "Jamais" },
                    { value: 1, text: "Moins d'une fois par mois" },
                    { value: 2, text: "Environ une fois par mois" },
            ...
            },
            {
                ...
                prompt: "Avez-vous déjà envisagé de réduire ou d'arrêter votre consommation de cannabis ?",
                options: [
                    { value: 0, text: "Jamais" },
        ...
        scoring: {
            ...
            maxScore: 32,
            method: "Additionnez les scores de chaque item (items 1-7 : 0-4 ; item 8 : 0, 2 ou 4). Le score total varie de 0 à 32. De 8 à 10 : consommation possiblement problématique ; au-delà de 10 : trouble de l'usage possible.",
        },
    },
    {
        id: "hsps",
        ...
        description: "Un auto-test de 23 items (oui/non) issu des travaux d'Elaine Aron sur la haute sensibilité de traitement sensoriel",
        ...
        instructions: "Répondez de la façon la plus sincère possible à chaque question.\n\nRépondez OUI si cela s'applique le plus souvent à vous. Répondez NON si cela ne s'applique pas vraiment ou pas du tout à vous.",
        copyrightAttribution: "Questionnaire d'hypersensibilité — Elaine N. Aron, The Highly Sensitive Person (1996). Traduction française : « Ces gens qui ont peur d'avoir peur », Éditions de l'Homme.",
        higherIsBetter: false,
        questions: [
        ...
        scoring: {
            ...
            maxScore: 23,
            method: "Comptez les réponses OUI (1 point chacune). Le score total varie de 0 à 23. À partir de 12 réponses OUI, une hypersensibilité est probable.",
        },
    },
    {
        id: "qia",
        ...
        description: "Un questionnaire de 11 items évaluant la présence et la sévérité des symptômes du trouble anxieux généralisé (inquiétudes, symptômes somatiques, interférence)",
        category: "Anxiété généralisée",
        estimatedTime: "5 minutes",
        ...
        instructions: "Ce questionnaire porte sur vos inquiétudes et votre anxiété au cours des six derniers mois.\n\nVous listerez d'abord les sujets à propos desquels vous vous inquiétez le plus souvent, puis vous répondrez à chaque question en choisissant le chiffre correspondant (0 à 8).",
        copyrightAttribution: "Questionnaire sur l'Inquiétude et l'Anxiété (QIA / WAQ) — Dugas, Freeston, Provencher, Lachance, Ladouceur & Gosselin (2001), Journal de Thérapie Comportementale et Cognitive, 11(1), 31-36. Instrument original francophone.",
        higherIsBetter: false,
        openingTextItem: {
            key: "worry_themes",
            questionText: "Quels sont les sujets à propos desquels vous vous inquiétez le plus souvent ?",
            helperText: "Listez jusqu'à six sujets (par exemple : santé, travail, famille, finances…).",
        },
        sectionIntros: [
            {
                startIndex: 3,
                text: "Sensations physiques",
                description: "Durant les derniers six mois, avez-vous souvent été troublé(e) par une ou l'autre des sensations suivantes lorsque vous étiez inquiet(ète) ou anxieux(se) ? Cotez chaque sensation de 0 à 8.",
            },
        ],
        questions: [
            {
                title: "Caractère excessif des inquiétudes",
                prompt: "Est-ce que vos inquiétudes vous semblent excessives ou exagérées ?",
                options: [
            ...
            },
            {
                ...
                prompt: "Durant les derniers six mois, combien de jours avez-vous été troublé(e) par des inquiétudes excessives ?",
                options: [
            ...
            },
            {
                ...
                prompt: "Est-ce que vous avez de la difficulté à contrôler vos inquiétudes ? Par exemple, lorsque vous commencez à vous inquiéter à propos de quelque chose, avez-vous de la difficulté à vous arrêter ?",
                options: [
            ...
            {
                title: "Sensations physiques",
                prompt: "Problèmes de sommeil (difficulté à tomber ou rester endormi(e) ou sommeil agité et insatisfaisant)",
                options: [
                    { value: 0, text: "0 — Aucunement" },
                    { value: 1, text: "1" },
                    { value: 2, text: "2" },
            ...
            },
            {
                ...
                prompt: "À quel point est-ce que l'anxiété ou l'inquiétude interfère avec votre vie, c'est-à-dire votre travail, activités sociales, famille, etc. ?",
                options: [
                    { value: 0, text: "0 — Aucunement" },
                    { value: 1, text: "1" },
                    { value: 2, text: "2" },
            ...
            ranges: [
                {
                    min: 0,
                    max: 80,
                    interpretation: "Plus le score est élevé, plus la symptomatologie d'inquiétude et d'anxiété est marquée.",
                },
            ],
            maxScore: 80,
            method: "Additionnez les 10 items cotés (0-8), l'item 1 (thèmes d'inquiétude) n'est pas coté. Le score total varie de 0 à 80. La cotation par critères repère un profil compatible avec le TAG : ≥ 1 thème d'inquiétude, score ≥ 4 aux items 2, 3, 4 et 6, et ≥ 4 sur au moins 3 des 6 sensations somatiques.",
        },
    },
];
