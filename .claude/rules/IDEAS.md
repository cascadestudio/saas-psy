...
- **Génération d'avatar patient (comme GitHub)**: Générer automatiquement des avatars colorés et identifiables pour chaque patient basés sur leur nom ou ID (style Identicon/GitHub)
